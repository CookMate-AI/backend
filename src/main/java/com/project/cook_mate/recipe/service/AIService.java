...
public class AIService {
    ...
    public Mono<String[]> getRecipe(String ingredients, String food) throws Exception{
        ...
        String prompt = String.format("우선 답변의 예시를 줄테니까 무조건 예시에 맞춰 답변을 줘. 예시) 2 | 레시피 부분." +
                "우선 %s를 카테고리에 맞게 구분해줘(한식:1, 양식:2, 중식:3, 일식:4, 기타 혹은 구분 어려운 경우:5). " +
                "그리고 %s가 들어간 %s의 레시피를 1개만 한글로 알려주는데 재료의 종류나 양 그리고 각 과정에서 소요되는 시간도 제대로 명시를 해줘." +
                "만약 재료의 개수가 지정이 안된경우엔 1인분 기준의 레시피로 작성해줘" +
                "레시피 설명에 대한 목차 순서는 재료, 레시피, 팁 순으로 작성해주고 레시피 부분의 경우 서론을 붙이지 말고 레시피만 적어줘." +
                "그리고 다시한번 말하지만 답변의 경우, 작성할 때 앞에 아무것도 쓰지말고 카테고리에 해당하는 숫자를 무조건 먼저 작성후 구분자(|)로 구분한 뒤에 레시피를 출력해줘."
